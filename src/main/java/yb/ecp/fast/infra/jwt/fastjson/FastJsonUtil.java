package yb.ecp.fast.infra.jwt.fastjson;
...
public final class FastJsonUtil {
    ...
    public static ActionResult<SysUserLoginInfoVO> parseInputStream(InputStream inputStream, Class<ActionResult> actionResultClass) throws IOException {
        return parse(convertStream2Json(inputStream), actionResultClass);
    }
}
